...
south and east. The exit is to the west.""",
    ...
    "exits": {"south": "Admins", "west": "Parking", "east": "Tutor"} # DONE
}
...
general office.""",
    ...
    "exits": {"south": "Reception", "east": "Office"} # DONE
}
